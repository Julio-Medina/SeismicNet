...
# Script for evaluating the results of SeismicNet and collecting all the results in .png images
# depending on the result of the prediction the image is saved in different folders
